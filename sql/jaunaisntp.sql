...
WHERE cp."NtpErrorMillis" IS NOT NULL
  ...
  AND pr."PictureTime" >= TIMESTAMPTZ '2026-03-02 15:25:56.646204 +00:00'
GROUP BY
    pr."PictureSetId",
    cp."CameraId"
UNION
...
FROM "CameraPictures" cp
         JOIN "PictureRequests" pr ON pr."Uuid" = cp."PictureRequestId"
WHERE cp."NtpErrorMillis" IS NOT NULL AND pr."PictureSetId" IS NULL AND pr."PictureTime" >= TIMESTAMPTZ '2026-03-02 15:25:56.646204 +00:00'