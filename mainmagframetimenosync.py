...
CSV_PATH = Path("AllFrameTimeNoSync.csv")  # change path if needed
HISTOGRAM_PATH = Path("frametime_nosync_histogram.png")
...
plt.title("Kadru laiku histogramma (nesinhronizēts)")
plt.xlabel("Atšķirība no pirmās ierīces (ms)")
plt.ylabel("Skaits")
